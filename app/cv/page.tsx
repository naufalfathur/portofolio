...
function CVpage() {
    ...
    return (
        <main className="flex min-h-screen flex-col items-center justify-between  ">
            ...
            <Navbar />
            <div className='max-w-6xl w-full px-4 space-y-4 py-24 z-50'>
                <h2 className={`text-3xl font-extrabold text-center w-full` + bitter.className}>Curriculum Vitae</h2>
                <p className='text-sm font-light text-center'>
                    A concise snapshot of my professional journey, skills, and experiences across tech, design, and business. Downloadable version available.
                </p>
