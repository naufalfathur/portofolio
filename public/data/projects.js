export const projectList = [
    {
        ...
        desc: [
            ...
            "Shorten Finance Manager task with the payroll system that handles EPF, SICSO, TAX calculations automatically.",
            "Ability to connect with an attendance device IoT system for attendance management."
        ],
        technologies: [
            "HTML",
            "PHP",
