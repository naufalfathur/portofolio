        ...
        <div className='py-20 px-[15vw] w-full mb-10'>
            <div className="card lg:card-side h-full py-10 video-container">
                ...
                <div className="card-body w-full caption py-10 text-neutral-content">
                    <div className='w-[150px] py-4'><img src="https://generatif.co/storage/2023/06/generatif-300x66.png" alt="Album" /></div>
                ...
                <figure className='w-full -mt-20 rotate-12'><img src="/img/generatif.png" alt="Album" /></figure>
